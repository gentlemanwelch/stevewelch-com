...
export const investmentVehicles = {
  ...
  vehicles: [
    ...
    },
    {
      ...
      /*
        The real mark: the orange hammerhead beside "SHARK SKIN VENTURES", from
        the studio's own SVG. It arrived via Google Drive — pasting it into a
        chat had never put a file anywhere this session could reach.
      */
